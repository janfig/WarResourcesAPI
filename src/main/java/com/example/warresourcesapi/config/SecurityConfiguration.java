...
import com.example.warresourcesapi.filter.JWTAuthenticationFilter;
import com.example.warresourcesapi.filter.JWTAuthorizationFilter;
import com.example.warresourcesapi.service.AuthenticationUserDetailService;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    @Override protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().authorizeRequests()
            .antMatchers(
                    HttpMethod.POST,
                    AuthenticationConfigConstants.SIGN_UP_URL).permitAll()
